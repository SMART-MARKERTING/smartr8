export type FunnelId = "heloc" | "helocmeta" | "dscrcometa" | "cashout" | "rate-reduction" | "purchase" | "legal" | "see-my-options";
...
function loanRequest(funnelType: FunnelId): string {
  ...
  if (funnelType === "helocmeta") return "Mortgage Rate Quote";
  if (funnelType === "dscrcometa") return "DSCR Investor Loan Quote";
