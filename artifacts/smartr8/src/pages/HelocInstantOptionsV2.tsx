  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* COMPACT HERO */}
        <div
          className="px-4 py-8 sm:py-12 text-center text-white"
          style={{ background: "linear-gradient(135deg, #0d3140 0%, #13485A 60%, #1a6070 100%)" }}
        >
          <div className="container mx-auto max-w-3xl">
            <div className="inline-flex items-center gap-2 text-[11px] font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-4 border border-white/20 bg-white/10">
            ...
            <div className="grid grid-cols-3 gap-2 mt-6 max-w-xl mx-auto">
              {TRUST_PILLS.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex flex-col items-center justify-center text-center gap-1.5 py-2.5 px-2 rounded-xl border border-white/15 bg-white/10 backdrop-blur-sm"
                >
