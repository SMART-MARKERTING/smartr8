      ...
      <main className="flex-1">
        ...
        <section className="py-20 px-4 bg-secondary/30 container mx-auto max-w-4xl text-center">
          ...
          <div className="prose prose-lg mx-auto text-muted-foreground">
            ...
            <p className="mb-8">
              I work with 99+ wholesale lenders including Rocket, loanDepot, Carrington, CAKE, and more, which means I'm not stuck pitching one product. I look at your situation and bring you the option that actually fits.
            </p>
